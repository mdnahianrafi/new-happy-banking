        ...
        <MobileContainer>
          ...
          <div className="bg-white m-3 shadow-lg relative">
            ...
            <form action="" onSubmit={handleSUbmit} className="mx-3 space-y-3">
              {/* Name */}
              <div>
                <p className="text-[#464646] text-base leading-6">
                  Name <span className="text-red-500">(required)</span>
                </p>
                <div className="flex my-1">
                  <label>
                    <FaUser className="p-3 text-gray-600 text-4xl bg-gray-300 rounded-l-lg" />
                  </label>
                  <input
                    type="text"
                    name="name"
              ...
              <div>
                ...
                <div className="flex my-1">
                  <label>
                    <IoIosCall className="p-3 text-gray-600 text-4xl bg-gray-300 rounded-l-lg" />
                  </label>
                  <input
                    type="tel"
                    name="mobile"
              ...
              <div className="my-2">
                ...
                <div className="flex my-2 border border-gray-300 rounded overflow-hidden">
                  {[
                    {
                      label: "Male",
                      icon: <IoIosMale className="mr-2 text-2xl" />,
                    },
                    {
                      label: "Female",
                      icon: <IoIosFemale className="mr-2 text-2xl" />,
                    },
                  ].map((option) => (
                    <button
                      type="button"
              ...
              <div>
                ...
                <div className="flex my-1">
                  <label>
                    <FaBriefcase className="p-3 text-gray-600 text-4xl bg-gray-300 rounded-l-lg" />
                  </label>
                  <input
                    list="professions"
                    name="profession"
              ...
              <div>
                ...
                <div className="flex my-1">
                  <label>
                    <FaWallet className="p-3 text-gray-600 text-4xl bg-gray-300 rounded-l-lg" />
                  </label>
                  <input
                    type="number"
                    name="wallet"
              ...
              <div>
                ...
                <div className="flex my-1">
                  <label>
                    <IoLocationSharp className="p-3 text-gray-600 text-4xl bg-gray-300 rounded-l-lg" />
                  </label>
                  <input
                    type="text"
                    name="address"
